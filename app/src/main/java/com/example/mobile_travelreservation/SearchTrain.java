...
public class SearchTrain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Ticket class array
        autoCompleteTextView_classes = findViewById(R.id.autocomplete_dropdown_tkt_class);
        ...
        autoCompleteTextView_classes.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(SearchTrain.this, item, Toast.LENGTH_SHORT).show();
            }
        });

        // Render the ticket quantity array
        autoCompleteTextView_ticket_qty = findViewById(R.id.autocomplete_dropdown_tkt_qty);
        ...
        autoCompleteTextView_ticket_qty.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(SearchTrain.this, item + " Tickets", Toast.LENGTH_SHORT).show();
            }
        });

        // Destination station array
        autoCompleteTextView_dest_station = findViewById(R.id.autocomplete_dropdown_tkt_dept_station);
        ...
        autoCompleteTextView_arrival_station = findViewById(R.id.autocomplete_dropdown_tkt_arrival_station);
    ...
    public void showDateTimePicker(View view) {
        textViewer_Date = findViewById(R.id.date_viewer);
        ...
        new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                if (date.compareTo(currentDate) < 0) {
                    ...
                    Toast.makeText(getApplicationContext(), "The selected date is in the past", Toast.LENGTH_SHORT).show();
                    return;
                }

                String selectedDate = DateFormat.getDateInstance(DateFormat.FULL).format(date.getTime());
                Log.v(TAG, "The chosen date is " + selectedDate);
                ...
                new TimePickerDialog(SearchTrain.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        date.set(Calendar.HOUR_OF_DAY, hourOfDay);
                        date.set(Calendar.MINUTE, minute);
                        String selectedTime = DateFormat.getTimeInstance(DateFormat.SHORT).format(date.getTime());
                        Log.v(TAG, "The chosen time is " + selectedTime);
    ...
    public void checkAvailability(View view){
        ...
        checkAvailability = findViewById(R.id.chk_availability);
